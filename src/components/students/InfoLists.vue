<template>
    <div class="infoList">
        <el-form :inline="true" class="demo-form-inline" size="small">
            <el-form-item>
                <el-button type="primary" @click="addStudent('form')">新增</el-button>
            </el-form-item>
        </el-form>
...
<script>
    import { studentNameRule, phoneRule } from "@/utils/vaildate.js";
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [{validator:studentNameRule, trigger: 'blur',required: true}],
            ...
            sure(form){
                this.$refs[form].validate(valid => {
                    if(valid) {
                        ...
                        changeInfo(this, methods, '/info', this.form) */
                        if(this.state){
                            this.form.id = nanoid();
                            changeInfo(this, 'POST', '/info', this.form)
                        } else {
                            changeInfo(this, 'PUT', '/info', this.form)
                        }
                        getData(this, '/info');
                    }
                })
